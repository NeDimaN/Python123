from view_film import UserInterface
from model_film import FilmModel


class Controller:
    def __init__(self):
        self.film_model = FilmModel()  # связка для model
        self.user_interface = UserInterface()  # связка для view
